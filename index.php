<?php
    ...
    foreach($wordsCounter as $word => $amount) {
        echo("$word: $amount\n");
    }
    echo("----------\n");
    echo("Всего слов: $totalLength");
?>